...
The BMI Calculator app is a tool that allows users to calculate their Body Mass Index (BMI) based on their height, weight, and gender

 Live :  https://bmi-calculatorreactjs.netlify.app/
